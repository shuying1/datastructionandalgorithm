package com.iflytek.prim;

import java.util.Arrays;

/**
 * @author yings
 * @create 2022-08-03 9:59
 */
...
//            }
        ...
        for (int i = 0; i < graph.vertex - 1; i++) {//因为有 graph.vertx 个顶点，普利姆算法结束后，有 graph.vertex-1 条边
            //这个是确定每一次生成的子图 ，和哪个结点的距离最近
            for (int j = 0; j < graph.vertex; j++) {// j 结点表示被访问过的结点
                for (int k = 0; k < graph.vertex; k++) {//k 结点表示还没有访问过的结点
