...
/**
 * https://www.cnblogs.com/zzuuoo666/p/9028287.html   KMP算法
 * @author yings
 * @create 2022-08-03 22:49
 */
public class Strstr {

    public static void main(String[] args) {
        String haystack = "hello", needle = "ll";
        int index = strStr4(haystack, needle);
    ...
    public static void getNext(String p, int[] next) {
        ...
        while (i < len - 1) {
            if (j == -1 || p.charAt(i) == p.charAt(j)) {
                ...
                /**
                 * 关键是这里不好理解，为什么匹配失败要让j等于next[j]，要记住这里的next[j]是指匹配成功的数量，有可能为0，也有可能是其他数.比如
